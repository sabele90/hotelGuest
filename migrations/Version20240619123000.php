 ...
 */
final class Version20240619123000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE guest CHANGE name name VARCHAR(255) NOT NULL, CHANGE surname surname VARCHAR(255) NOT NULL, CHANGE date_of_birth date_of_birth DATE NOT NULL, CHANGE passport_number passport_number VARCHAR(255) NOT NULL, CHANGE country country VARCHAR(255) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE registration_id registration_id INT DEFAULT NULL');
