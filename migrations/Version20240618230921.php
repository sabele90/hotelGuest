 ...
 */
final class Version20240618230921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE guest (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, registration_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, gender VARCHAR(1) NOT NULL, passport_number VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, INDEX IDX_ACB79A35A76ED395 (user_id), INDEX IDX_ACB79A35833D8F43 (registration_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
